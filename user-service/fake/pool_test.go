...
func TestPushRow_Error(t *testing.T) {
	p := &Pool{}
	p.PushRow(fmt.Errorf("scan error"))
...
func TestPushRows_Error(t *testing.T) {
	p := &Pool{}
	p.PushRows(fmt.Errorf("query error"))
...
func TestPushExec_Error(t *testing.T) {
	p := &Pool{}
	p.PushExec(0, fmt.Errorf("exec error"))
...
func TestAssignOne_PointerToString(t *testing.T) {
	var dst *string
	if err := assignOne(&dst, "hello"); err != nil {
...
func TestAssignOne_NilSource(t *testing.T) {
	var dst string
	if err := assignOne(&dst, nil); err != nil {
...
func TestAssignOne_IntToInt64(t *testing.T) {
	var dst int64
	if err := assignOne(&dst, int64(100)); err != nil {
...
func TestAssignOne_IntConversion(t *testing.T) {
	var dst int64
	if err := assignOne(&dst, 42); err != nil {
...
func TestAssignAll_MismatchedLengths(t *testing.T) {
	...
	if err := assignAll(dests, vals); err != nil {
...
func TestRows_ScanNoCurrentRow(t *testing.T) {
	...
	var s string
	if err := fakeRows.Scan(&s); err == nil {
...
func TestAssignOne_FloatConversion(t *testing.T) {
	var dst float32
	if err := assignOne(&dst, float64(3.14)); err != nil {
...
func TestAssignOne_TypeConversion(t *testing.T) {
	...
	var dst int64
	if err := assignOne(&dst, int32(99)); err != nil {
