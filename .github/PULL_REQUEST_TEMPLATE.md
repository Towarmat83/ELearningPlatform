...
- [ ] Successfully built and ran the platform locally against a kubernetes cluster.
- [ ] Ensured connection still works
- [ ] Ensured that the platform is still functional and all features are working as expected.
