...
func (s *State) Login(w http.ResponseWriter, r *http.Request) {
	...
	var (
		id, username, email, role, authProvider string
		passwordHash, avatarURL, bio            *string
		isActive                                bool
		createdAt                               string
	)
...
// @Accept    json
// @Produce   json
// @Param     body  object  true  "Fields: username, bio, avatar_url (all optional)"
// @Success   200   {object}  userPublicRow
// @Failure   400   {object}  map[string]string
...
// @Accept    json
// @Produce   json
// @Param     body  object  true  "old_password and new_password"
