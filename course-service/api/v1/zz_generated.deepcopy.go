...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PathCourseEntry) DeepCopyInto(out *PathCourseEntry) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PathCourseEntry.
func (in *PathCourseEntry) DeepCopy() *PathCourseEntry {
	if in == nil {
		return nil
	}
	out := new(PathCourseEntry)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PathSpec) DeepCopyInto(out *PathSpec) {
	*out = *in
	if in.Courses != nil {
		...
		*out = make([]PathCourseEntry, len(*in))
		copy(*out, *in)
	}
}
